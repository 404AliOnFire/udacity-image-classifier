...
def calculates_results_stats(results_dic):
    ...
    n_correct_dogs, n_correct_notdogs = 0, 0
    n_dogs_img, n_notdogs_img, n_correct_breed, n_match = 0, 0, 0, 0
    pct_correct_breed, pct_correct_dogs, pct_match, pct_correct_notdogs = 0, 0, 0, 0

    for key, value in results_dic.items():  
        n_correct_dogs += (value[3] and value[4])
        n_correct_notdogs += int(value[3] == 0 and value[4] == 0)
        n_dogs_img += value[3]
        n_correct_breed += (value[3] and value[2])
        n_match += value[2]
